          ...
          <div className="grid">
            ...
            <div className="background-color-text p-10">
              ...
              <div className="mt-3 flex flex-col sm:flex-row gap-4">
                <Link href={"/adultes-couples"}  className="bg-[#2E3A59] text-white px-6 py-3 rounded-lg font-semibold transition hover:bg-[#1d2536] text-center sm:text-base text-sm hover-lift card-hover">Psychothérapie Adultes et Couples</Link>
                <Link href={"/enfants-adolescents"}  className="border-2 border-[#2E3A59] text-[#2E3A59] px-6 py-3 rounded-lg font-semibold transition hover:bg-[#e5eaf3] bg-white text-center sm:text-base text-sm hover-lift card-hover">Psychothérapie Enfants et Adolescents</Link>
              </div>
            </div>
          </div>
        </section>
