            ...
            {isSubMenuOpen && (
              <>
                <li className="py-2 border-b border-gray-100 pl-4">
                  <Link href={"/psychotherapie/adultes-couples"} onClick={toggleMenu} className="transition-all duration-300 hover:text-[#A2B6C9]">- Adultes et couples</Link>
                </li>
                <li className="py-2 border-b border-gray-100 pl-4">
                  <Link href={"/psychotherapie/enfants-adolescents"} onClick={toggleMenu} className="transition-all duration-300 hover:text-[#A2B6C9]">- Enfants et adolescents</Link>
                </li>
              </>
            )}
            <li className="py-2 border-b border-gray-100">
